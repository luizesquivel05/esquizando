...
## 🚀 Instalando AstroBios:

Para instalar o AstroBios, siga estas etapas:
...
Para usar AstroBios, siga estas etapas:

```
    Abrir o navegador de preferência.

    Colar a URL: https://luizesquivel05.github.io/esquizando/AstroBios.html
```

## 📫 Contribuindo para AstroBios:
Para contribuir com AstroBios, siga estas etapas:

1. Bifurque (clone) este repositório.
2. Crie um branch: `git checkout -b <nome_branch>`.
3. Faça suas alterações e confirme-as: `git commit -m '<mensagem_commit>'`
4. Envie para o branch original: `git push origin AstroBios / <local>`
...
## 🚀 Installing AstroBios:

To install AstroBios, follow these steps:
...
To use AstroBios, follow these steps:

```
Open your preferred web browser.

Paste the URL: https://luizesquivel05.github.io/esquizando/AstroBios.html
```

## 📫 Contributing to AstroBios:
To contribute to AstroBios, follow these steps:

1. Fork (clone) this repository.
2. Create a branch: `git checkout -b <branch_name>`.
3. Make your changes and commit them: `git commit -m '<commit_message>'`.
4. Push to the original branch: `git push origin AstroBios/<location>`.
